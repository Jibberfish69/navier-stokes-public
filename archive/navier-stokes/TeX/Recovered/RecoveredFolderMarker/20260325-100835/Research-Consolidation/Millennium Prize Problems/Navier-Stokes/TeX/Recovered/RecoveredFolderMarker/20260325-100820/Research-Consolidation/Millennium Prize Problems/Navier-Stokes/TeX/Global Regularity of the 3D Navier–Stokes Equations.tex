...
\begin{abstract}
This document presents a proof framework for establishing global regularity of the 3D Navier--Stokes equations. The approach integrates four foundational principles: Energy Boundedness, Scale-Barrier Principle, Non-Sobolev Compactness, and Gradient Control through Geometric Arguments.
\end{abstract}
