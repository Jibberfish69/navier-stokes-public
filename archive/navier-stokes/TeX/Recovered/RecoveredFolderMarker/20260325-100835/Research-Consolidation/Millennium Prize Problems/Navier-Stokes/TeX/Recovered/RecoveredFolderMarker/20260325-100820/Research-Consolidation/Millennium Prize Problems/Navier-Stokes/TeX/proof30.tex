...
\end{aligned}
\label{eq:RegNS}
\end{equation}  % <-- Fixed the label placement here (Line 54)
...
\end{equation}
\end{theorem}  % <-- Fixed misplaced \end{theorem} (Line 68)
...
\end{equation}  % <-- Ensure this equation is closed properly (Line 77)
