...
> Extraction notice:
> For Marvin / Chat Y / monograph-V6 intake, treat
...
> and [theorem-to-warrant.yaml](/Users/thomasbirnie/Documents/Research-Consolidation/problems/navier-stokes/theorem-to-warrant.yaml)
> as the stable extraction surfaces. This draft is a legacy working note and may
> lag the solver-facing theorem packet.
