...
\eqref{eq:qc-B-by-height-reconstruction} express those finite rows in the
...
special energy cases follow from \eqref{eq:energy-Linf} and
...
the rectangle coordinates, this is a re-expression of that finite information about the original history rather than a new estimate from the critical-height
rows.
\begin{samepage}
