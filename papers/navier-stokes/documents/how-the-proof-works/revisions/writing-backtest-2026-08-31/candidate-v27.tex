...
\]
the stretching part raises \(\lvert\omega\rvert\) while the core narrows. Since vorticity is one spatial derivative of velocity, the velocity changes across less distance and its gradients steepen. The nonlinear motion has concentrated velocity variation into a narrower core; viscosity acts against it by diffusion.
