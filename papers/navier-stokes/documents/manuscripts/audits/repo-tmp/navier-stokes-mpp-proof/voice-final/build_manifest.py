...
source_path = Path(
    "/Users/thomasbirnie/.codex/attachments/848928b3-d337-4982-998f-6fa22d570fe0/pasted-text.txt"
)
...
positions = [(content_id, text.index(marker)) for content_id, marker in markers]
items = []
