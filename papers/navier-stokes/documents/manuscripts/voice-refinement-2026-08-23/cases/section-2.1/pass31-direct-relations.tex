...
The four terms share the factor \(\lambda^3\), while the Sobolev norms scale by different powers of \(\lambda\). Let \(\Lambda:=(-\Delta)^{1/2}\). Since
\[
...
\]
A finer copy carries less energy and more first-derivative energy at the same critical height. Any rise in \(H\) must come from the evolution of the original solution.
