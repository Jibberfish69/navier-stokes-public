...
When the strain extends the fluid in that direction,
\[
  Se=\sigma(t)e,
  \qquad
  \sigma(t)>0,
...
The last identity measures the lengthening already in view: \(\sigma(t)\) is the segment's instantaneous fractional growth rate.
