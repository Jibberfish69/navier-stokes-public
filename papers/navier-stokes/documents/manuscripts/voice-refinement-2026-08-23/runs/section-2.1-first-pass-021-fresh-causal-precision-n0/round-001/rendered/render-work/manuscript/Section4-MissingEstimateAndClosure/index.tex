...
\begin{equation}\label{eq:EndpointCriterionFromLowRectangle}
  \sup_{0\leq t\leq T_*}\norm{u(t)}_3<\infty.
\end{equation}
This is where the finite maximal-time criterion is met by the first rectangle.
...
The energy identity proved in \Cref{prop:ClassicalKineticEnergyIdentity} holds on every finite
