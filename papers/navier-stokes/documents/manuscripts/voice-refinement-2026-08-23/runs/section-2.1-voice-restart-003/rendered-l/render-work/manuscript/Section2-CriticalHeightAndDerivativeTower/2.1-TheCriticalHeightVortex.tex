...
Vortex stretching brings that competition inside a single piece of fluid.
In a narrow material vortex tube, the vorticity runs along the tube's axis.
When the surrounding strain draws one segment out in that direction, the segment lengthens; because its volume cannot change, it narrows at the same time.
...
\end{aligned}
\]
Every term has gained the same \(\lambda^3\).
At the finer width, viscosity has gained nothing on nonlinear sharpening.
...
\]
Energy falls and first-derivative energy rises while \(H\) stays fixed.
Any change in \(H\) along the evolving solution must come from the equation itself, not from the shrinking ruler.

\divider{Nonlinear Production versus Viscous Dissipation}

Applying \(\Lambda^{1/2}\) to the momentum equation and pairing with \(\Lambda^{1/2}u\) isolates that change.
Write the signed nonlinear contribution as
\[
  \mathcal P_{1/2}(t)
  :=
  -\operatorname{Re}
...
\]
Production and dissipation still rise together.
Their common \(\lambda^2\) is the inverse of the contracted time coordinate \(t\mapsto\lambda^{-2}t\): the spatial balance has survived, but its clock has shortened.
