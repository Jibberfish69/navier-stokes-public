...
To separate actual growth from a change of scale, we need a measure the comparison itself cannot raise.
...
For them to describe a candidate singularity, one \NavierStokes{} solution must pass through widths
\[
