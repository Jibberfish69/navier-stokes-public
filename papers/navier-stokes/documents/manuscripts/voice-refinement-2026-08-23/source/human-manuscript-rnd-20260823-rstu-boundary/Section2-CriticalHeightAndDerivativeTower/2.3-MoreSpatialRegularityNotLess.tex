...
Such a bound extends that rectangle from the strict cutoffs to \(I_*=(0,T_*)\).
If it holds for every finite \(N\) and \(M\), the compatible rectangles place every finite time--space coordinate in their intersection.
