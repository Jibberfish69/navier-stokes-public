...
The surrounding flow pulls a vortex along its axis.
Follow one material fluid segment as it lengthens.
If \(e\) is its axial direction and \(L(t)\) its length, the symmetric strain
\[
...
Although the four terms retain their relative strength, the Sobolev norms of \(u_\lambda\) do not.
...
Along the solution itself, apply \(\Lambda^{1/2}\) to the momentum equation and pair with \(\Lambda^{1/2}u\).
...
\]
Production and dissipation remain matched in scaling, and their common \(\lambda^2\) factor is the inverse of the time contraction \(t\mapsto\lambda^{-2}t\).
