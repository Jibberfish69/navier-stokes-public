...
The datum-generated whole-terminal family received by the formal closure has precisely this bound at every finite rectangle.
Its production and the terminal assembly it licenses are part of that formal closure and are not repeated here.
The discovery made in this section identifies exactly what that producer acts on: the pressure-complete mixed jet, read through every finite adjacent Sobolev rectangle, with all overlapping coordinates compatible.
Once each fixed rectangle has its cutoff-independent bound, moving the right endpoint of integration toward \(T_*\) cannot make a mixed coordinate escape.
At the terminal face, every fixed finite pressure-complete mixed rectangle carries its own datum-dependent bound and agrees with every overlapping view.
