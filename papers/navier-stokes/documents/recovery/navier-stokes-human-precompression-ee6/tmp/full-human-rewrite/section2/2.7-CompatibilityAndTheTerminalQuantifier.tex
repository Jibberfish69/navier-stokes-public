...
The coordinatewise intersections from the previous subsection therefore refer to one velocity--pressure history.

One issue remains before an endpoint can enter the argument.
Fix \(T<T_*\).
...
\[
  ...
  \infty.
\]
Every finite rectangle is therefore finite after its strict right endpoint has been fixed.
...
The datum-generated compatible-rectangle theorem supplies this whole-terminal statement for every finite pressure-complete rectangle of the same history.
