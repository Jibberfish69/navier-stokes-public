...
The three-dimensional Navier--Stokes regularity problem asks whether a smooth fluid can lose its smoothness after a finite amount of time.
Classical local theory already constructs the motion for a short time.
The unresolved question is whether any finite time can be its last smooth time.
