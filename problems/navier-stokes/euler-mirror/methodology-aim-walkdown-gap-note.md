# Methodology-and-Aim Walkdown Completion Note

The methodology-and-aim walkdown contract is now **complete**.

What is complete:

1. every serious Navier-Stokes proof road in scope now has a theorem-facing
   Euler route surface;
2. each route is classified as surviving, surviving-with-modification,
...
5. `Exact-potential`
   The witness-to-readout splice survives as a target, but the first
   static-diffusion / heat step is non-Euler.
6. `Curvature / provenance`
