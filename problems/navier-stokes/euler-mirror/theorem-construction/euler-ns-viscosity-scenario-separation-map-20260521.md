...
nonsmoothness bridges, and `ESM.N3` has a global periodic smooth-layer
singular-limit bridge. `ESM.N4` is closed as the Wiedemann same-datum weak
branch import, and `ESM.N5` is closed as the Chen-Hou boundary/axisymmetric
smooth-data blowup import. `ESM.N6` is closed as a grammar theorem separating
shared flux-volume membership from one-field regularity.
...
| `ESM.N3` zero-thickness smooth-layer limit | nonsmooth control | global smooth periodic layers converge to a nonsmooth Euler member | topology/limit closure does not preserve one-field smoothness or prove fixed-datum blowup |
| `ESM.N4` same-datum nonclassical weak branch | nonsmooth control | Wiedemann gives global weak branches from the same periodic datum | fixed-`nu` transfer cannot identify weak-branch behavior with classical NS smoothness |
| `ESM.N5` boundary/axisymmetric blowup comparison | nonsmooth control | Chen-Hou supplies domain-sensitive smooth-data singularity evidence | not the no-boundary finite-energy Euler case |
| `ESM.N6` shared Pack / non-one-field split | nonsmooth control | shared Pack is flux-volume only; Part/Field are extra regularity/coherence layers; concrete failures are supplied by ESM.N1/N2 | NS Part/Field proofs become Euler nonsmoothness diagnostics, not Euler membership laws |
...
| B3. Smooth layers converging to slip | nonsmooth singular limit of smooth classical layers | positive-scale readout / topology warning | global finite-`p` closure of smooth stationary Euler shears does not preserve one-field coherence | [smooth-data bridge](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/mpp-smooth-data-to-euler-nonsmooth-bridge-20260517.md), [global smooth-layer limit](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/global-periodic-smooth-layer-to-slip-sheet-limit-20260524.md) |
| B4. Same-datum non-classical Euler branches | non-classical weak branch | weak-branch warning for NS transfer | Wiedemann gives infinitely many global bounded-energy weak periodic branches from the same datum; admissible branch selection is separate | [smooth-data bridge](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/mpp-smooth-data-to-euler-nonsmooth-bridge-20260517.md), [Wiedemann import](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/global-periodic-same-datum-weak-branch-euler-import-20260524.md) |
| B5. Fixed-datum boundary blowup | classical blowup in boundary/axisymmetric setting per recorded external route | domain-sensitive Euler singularity scenario | Chen-Hou supplies smooth-data boundary/axisymmetric blowup; not the no-boundary finite-energy problem | [smooth-data bridge](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/mpp-smooth-data-to-euler-nonsmooth-bridge-20260517.md), [Chen-Hou import](/Users/thomasbirnie/Workspace/ToE/Research-Consolidation/problems/navier-stokes/euler-mirror/theorem-construction/boundary-axisymmetric-smooth-data-euler-blowup-import-20260524.md) |
