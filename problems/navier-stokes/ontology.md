...
signed net work in F7.9 up to a strict remainder, prove same-carrier incidence
and quantitative persistence of the active dual gradients identified in
F7.10, and attach every captured core through the exact
