...
- `claim:` The witness enters the canonical CM terminal packet tree rather than being assumed to be a class member.
  ...
  `handoff:` Entry makes Silver Part/Field plus the outside-CM participation-field record-window original-participation audit the next typed failure analysis.
- `claim:` After Pack admission, the finite failure type is exhausted as not Part_{N,Q}, or forall r>0 not Field_{N,r,Q}; before Pack admission, a failed packet-window candidate first tests the original NS participation law.
...
- `role:` exhaustion
  `core_move:` Exhaust the finite failure type through Silver Part_{N,Q} and Field_{N,r,Q}; Pack_Q only as Field window evidence after Pack admission, while resurfacing outside-CM participation-field record-window failure candidates under the original participation law first.
  `must_keep:` not Pack_Q after Pack/carrier failure | not Part_{N,Q} | forall r>0 not Field_{N,r,Q} | outside-CM participation-field record-window original-participation audit
...
## Lexicon Lock
- `must_use:` CM contrapositive class-exit | finite Clay terminal witness | same-fluid CM terminal participation-field tree | Silver Pack_Q | Part_{N,Q} | Field_{N,r,Q} | outside-CM participation-field record-window original-participation audit | `Exit(Q):=not Member(Q)` | pass branch | fail branch
...
- `risk:` Source-wall, positive-supplier, periodic, or `Q(t)` material respawns as authority.
  `countermove:` Keep it quarantined unless the sentence names a checked Silver Part/Field landing or the outside-CM participation-field record-window original-participation audit.

## Draft Acceptance Test
- `pass_if:` the packet and draft open from the CM contrapositive class-exit program, name Silver Part/Field witness exhaustion after Pack admission, resurface outside-CM participation-field record-window failure candidates under the original participation law, and treat periodic / `Q(t)` material only as non-opening support
