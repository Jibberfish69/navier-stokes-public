...
| 013 | In the exact pure-diffusion/invariant-shear test, heat reweights existing Fourier directions by radius. This proves no full-NS monotone directional law, Fourier-support migration, spatial narrowing, energy travel through scales, or identification with vorticity direction. |
...
| 017 | Pressure has internal isotropic, trace-free, and pair-increment slots that recombine inside one VPI tangent. The source and trace-free curvature have finite component norms, but neither controls the two-slot pressure action; no pressure-only causal route or datum-finite pressure-action bound follows. |
...
| 024 | An assumed unbounded normalized record history satisfies a measure-theoretic efficiency/action dichotomy. The horns are snapshot classifications, not physical mechanisms; an extracted profile owns neither the record nor the material history. |
...
| 027 | An exact orientation-selected 2D3C null sector belongs to the participant and undergoes viscous loss while giving zero nonlinear feedback. Rotating wavevector-polarization activates transport and pressure; the family is varying-data and gives no record doubling. |
