...
| 013 | In a normalized periodic-\(\mathbb T^3\) invariant shear, pure diffusion reweights the already present Fourier directions. | Exact scale--direction covariance law on that pure-diffusion surface. | Heat selects existing radii and can change normalized spectral direction with either sign. | No full-NS monotone direction law, Fourier migration, spatial narrowing, or energy travel. | Exact solved-Navier--Stokes invariant-class countertest. |
