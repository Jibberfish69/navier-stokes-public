...
If those forward attempts fail in a precise way, the surviving obstruction can be sent downstream to the Part/Field witness tree. The classification receives an obstruction; it does not replace the forward analysis.
