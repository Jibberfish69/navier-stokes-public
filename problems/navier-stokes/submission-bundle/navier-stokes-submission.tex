...
At that point the reserve can support a Field diagnostic or a no-genuine-exit argument, because the terminal object is now attached to the same witness record.
\end{proof}
...
\[
  ...
  \text{CM-test entry}
  \Longrightarrow
  \text{Pack/Part/Field finite failure type}
  \Longrightarrow
  \Exit(Q;\Owork).
\]
