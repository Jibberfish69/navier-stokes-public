...
The forward-positive families are the source of the terminal objects.
Each family has two jobs in this manuscript.
It explains why the usual estimate route reaches a hard obstruction, and it says how the same obstruction is read by the class object.
The class proof becomes readable only when those two jobs are kept together.
...
The closing object is the terminal witness consumption chain:
\[
\begin{aligned}
