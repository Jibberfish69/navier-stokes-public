...
\begin{proposition}[The source-reserve failure branch enters Pack first]
Every source-reserve failure branch is tested first for a positive same-fluid carrier.
Its first possible class outcomes are
\[
  \neg\Pack_Q,\qquad
  \Pack_Q\wedge\neg\Part_{N,Q},\qquad
...
Failure at this level gives \(\Pack_Q\wedge\neg\Part_{N,Q}\).
...
These are exactly the three services required by the class object.
\end{proof}
