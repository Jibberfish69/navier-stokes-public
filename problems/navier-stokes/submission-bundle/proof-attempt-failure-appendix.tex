...
If the carrier is not admitted, the branch records carrier-window support outside
the exit conclusion.  Once admitted, the branch gives \(\neg\Part_{N,Q}\) or
\(\Part_{N,Q}\wedge\forall r>0\,\neg\Field_{N,r,Q}\).
That is the exact way the failure record becomes proof material without turning
carrier support into class exit.
