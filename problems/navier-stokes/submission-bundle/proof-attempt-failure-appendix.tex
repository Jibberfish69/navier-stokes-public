...
Calling it an exit at that point would skip the CM face test.
...
\[
  ...
  N_1(X)+N_2(X)
\]
suggests the dissipative-margin estimate
\[
  |N_1(X)|+|N_2(X)|
  \le
...
It turns the informal sentence ``viscosity wins at small scales'' into an
...
That would turn low-frequency strain into a coefficient controlled by the
viscous scale \(2^{2j}\).
