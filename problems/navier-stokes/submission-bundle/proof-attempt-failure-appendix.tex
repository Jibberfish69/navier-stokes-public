...
The exact proof burden is not the existence of a visually plausible critical
scale.  For \(K>0\), define the high-frequency enstrophy tail and the
...
\(T(k,t)=C_Tk^{-\alpha}\), \(E(k,t)=C_Ek^{-\beta}\) only explains why the route
was attractive: under those extra profile assumptions, the balance equation
would give
\[
  k_{\mathrm{crit}}
  =
