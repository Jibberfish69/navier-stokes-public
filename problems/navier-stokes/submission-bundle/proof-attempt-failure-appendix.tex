...
same-witness admission and a first Pack/Part/Field face failure.
...
derives the relevant Pack, Part, or Field consequence.
...
For the later class-membership proof, that residue becomes a Pack/Part/Field
face failure only after it is attached to the selected terminal object and tested
for Pack, Part, and Field.
