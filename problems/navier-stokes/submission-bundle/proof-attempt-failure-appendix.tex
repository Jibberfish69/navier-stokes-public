...
Its CM role is Field-window support zero-radius failure unless a retained positive-scale
...
A pure zero-radius endpoint is Field-window support failure unless a positive-scale
...
The CM proof has to say exactly where that object lands: usually Field-window support
...
If one fails first, the branch gives \(Field-window evidence outside CM\), \(\Pack_Q\wedge
\neg\Part_{N,Q}\), or \(\Part plus Field-window evidence_{N,Q}\wedge\forall r>0\,
\neg\Field_{N,r,Q}\).
...
In the later witness tree, zero-radius ancestry is Field-window support unless a retained
...
Zero-radius donor ancestry is already a Field-window support failure.
...
\[
  ...
  \Legal .
\]
With retained Field-window evidence and Part, the local public translator gives the Field-facing
critical readout.
...
With retained Field-window evidence and Part, that pure oscillatory branch should be a Field
...
Zero-radius residue lands first at Field-window support failure unless a positive-scale carrier is retained \\
Public local \(L^3\) &
