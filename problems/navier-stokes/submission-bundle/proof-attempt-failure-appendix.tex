...
If one fails first, the branch gives \(carrier-window support outside the exit conclusion\), \(\Pack_Q\wedge
\neg\Part_{N,Q}\), or \(\\Part_{N,Q}\wedge\forall r>0\,
\neg\Field_{N,r,Q}\).
...
\[
  O_{\Fail}
  \Longrightarrow
  carrier-window support outside the exit conclusion
  \vee
  \neg\Part_{N,Q}
  \vee
  \forall r>0\,\neg\Field_{N,r,Q}.
