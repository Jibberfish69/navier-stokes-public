...
same-witness admission and a first Part/Field Part/Field failure.
...
&\Longrightarrow\ \text{derive the first Part/Field Part/Field failure}\\
...
When the answer first fails, the branch supplies the Part/Field failure:
\[
  \neg\Pack_Q,
  \qquad
  \Pack_Q\wedge\neg\Part_{N,Q},
