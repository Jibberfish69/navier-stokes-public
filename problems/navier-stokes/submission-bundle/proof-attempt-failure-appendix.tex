...
For the later class-membership proof, that residue is not automatically a
Pack/Part/Field face failure. It has to be attached to the selected terminal
object and then tested for Pack, Part, and Field.
