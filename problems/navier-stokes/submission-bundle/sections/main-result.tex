...
\subsection{Periodic statement}

The result is proved on the periodic surface \(\mathbb T^3\).

\begin{theorem}[Periodic three-dimensional Navier--Stokes global smoothness]
Let \(\nu>0\). Let
\[
...
\qquad u(0)=u_0,
\]
has a unique global smooth periodic solution
...
\begin{lemma}[Endpoint contradiction]
