...
\[
  Z'(t)=C_\nu Z(t)^3
\]
has finite-time growth. The branch stops at a precise point. Energy
...
This is the branch's main lesson. The obstruction is not a
...
fail side is a terminal source-reserve object. Its final role is determined by
