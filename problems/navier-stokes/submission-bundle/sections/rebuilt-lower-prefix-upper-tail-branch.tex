...
\]
One stronger positive theorem would dominate both \(P_j^{\downarrow}\) and \(T_j^{\uparrow}\) by the same dissipative ledger. The CM proof does not require that collapse: each selected lower-prefix or upper-tail terminal family is tested separately through Pack, Part, and Field.
