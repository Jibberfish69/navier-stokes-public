...
\subsection{Current Gold Counterpart Boundary}
\label{subsec:current-gold-counterpart-boundary}

The Gold counterpart now sits at the continuation-strength material-clock
boundary.  The factorial tower and Stirling/binomial normalization are retained
as accounting support for the differentiated tower; they are not the live proof
supplier.  The active Gold burden is
\[
  \mathrm{ContinuationStrengthMaterialClockAtDepth.A},
\]
the theorem that the chosen continuation depth has a finite same-material
record strong enough to feed a separately proved same-solution restart.

This is CM-bearing because it proves the class participation law directly on
the original smooth history.  It is not CM-exit bearing by itself.  It supplies
Gold counterpart context unless it identifies a same-solution terminal witness
and lands that witness in Part or Field.
