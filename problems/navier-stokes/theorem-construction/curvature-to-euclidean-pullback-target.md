...
The original corpus already contains proposition-grade curvature statements. This
note records the old pullback burden only for provenance. After the promotion of
Route B, it is no longer a live theorem blocker.
...
`deprecated provenance burden after Route B promotion`
