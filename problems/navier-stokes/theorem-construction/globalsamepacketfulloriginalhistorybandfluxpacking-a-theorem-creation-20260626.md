...
- GlobalSamePacketFullOriginalHistoryBandFluxPacking.A (full_same_material_core_to_original_history_band_flux_packing; score=154)
...
- depth 0: GlobalSamePacketFullOriginalHistoryBandFluxPacking.A via full_same_material_core_to_original_history_band_flux_packing -> GlobalSamePacketFullOriginalHistoryBandFluxPacking.A.CoreSubprimitive
...
- core original-history cross-band transfer estimate giving the good-lambda contraction
...
1. Use the June 26 weight-beating and high-ratio tail audits as the governing source.
2. Keep heat-scale windows as samples of one original transported material history.
3. State the ratio-band packing theorem as the direct subprimitive for the good-lambda contraction.
4. Reject local finite-depth, scalar donor, viscosity-only, pressure-only, and stale proxy-clock replacements.
