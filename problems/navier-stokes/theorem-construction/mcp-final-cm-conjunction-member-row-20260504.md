...
Theorem-grade conjunction row. This note combines the three separately typed CM witness faces after the source-pulse supplier route has been spent through the Field row.
