...
The licensed outside-CM packet/window object is the original Navier-Stokes participation law,
...
`Part_{N,Q}` is not a separate outside-CM packet/window predicate.  It is the packet-local,
...
free outside-CM packet/window replacement for the whole-field or pointwise participation audit.

Scope: this note licenses the outside-CM packet/window original-participation audit and blocks
