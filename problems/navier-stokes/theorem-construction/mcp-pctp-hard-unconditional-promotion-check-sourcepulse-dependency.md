# PCTP.hard unconditional promotion check after conditional terminal-tail closure
...
The route surfaces consolidate every current source-control presentation into the same active theorem atom:
