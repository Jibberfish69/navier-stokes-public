...
| 5 | `ACT.X-Cut` | Moving affine coordinates, cutoff transport identity, Taylor control by `X_exc^(1/2)`, and absorbable `X_exc^(1/2)N`. | No source-side or endpoint input. | Clean cutoff package. |
