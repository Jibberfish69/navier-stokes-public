...
Pack-before-Part zero-radius diagnostic placement is already done. It gives Part-side support when the same original-NS participation record remains and true Pack support only when that record is absent, while it leaves the production problem open.
