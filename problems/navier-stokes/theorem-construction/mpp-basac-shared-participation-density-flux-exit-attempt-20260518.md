...
7. Therefore the atom cannot remain a legal `B_ASAC` member; it lands as Pack-out-of-CM typed CM exit support unless a separate positive-scale retained-carrier bridge is proved.
