...
Second, `ClayFiniteFailureTypeCMExhaustion.A` does the Pack-first work: the
...
contrapositive does not need to turn terminal face failure into an earlier
...
=> terminal CM class exit by Pack/Part/Field exhaustion.
```
