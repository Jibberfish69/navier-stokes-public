# MPP Final Release-Decision Boundary Note
...
Any public claim must be routed through the final release-decision surface and
must preserve the accepted target:

```text
T^3, smooth divergence-free zero-mean initial data, f=0
```

Whole-space, nonzero-forcing, or non-periodic claims require separate
target-fidelity bridges.
