...
ns_viewer:
  ...
  downstream_consequence: "The fixed-chain no-annular-share branch should not be respawned as a separate gold supplier. It is either closed forward-gold by a same-carrier annular-share/no-waste/source-square/CKN/saturation/profile theorem, or consumed CM-facing as a Part/Field face failure after same-witness admission. Center/frame/gauge drift remains outside this assembly and belongs to no-drift/profile production."
---
...
theorem, or it is a CM-facing Part/Field face failure on the same admitted
witness.
