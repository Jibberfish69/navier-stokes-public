...
Here \(d\Omega_N^{full}\) is the full coupled material transaction:
...
be admitted into \(d\Omega_N^{full}\), or eliminated by the coupled
...
prove finite total mass of \(d\Omega_N^{full}\).
