...
```math
\boxed{
\text{rule out or charge }(FHC.30a)\text{--}(FHC.33),
\text{ after transport, pressure, viscosity, and finite selectors are reduced.}
}
\tag{FHC.34}
```
...
or charge one of the exact defects `(FHC.30a)`--`(FHC.33)` into the existing
