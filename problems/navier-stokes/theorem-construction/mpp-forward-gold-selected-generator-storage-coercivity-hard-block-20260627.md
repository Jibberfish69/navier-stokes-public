...
## 3. Equivalence to stopped testing
...
or equivalently a concrete selected-generator storage coercivity theorem proving `(1)` from original stopped material-history data.
