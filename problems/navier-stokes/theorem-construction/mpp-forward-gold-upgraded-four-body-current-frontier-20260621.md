...
trace, viscous measure, selector graph loss, signed saturation loss, terminal
trace atom, or legal routing defect.  Each of those must be charged before the
no-residue theorem can use the rigidity core.
