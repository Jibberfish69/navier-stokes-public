...
So it is legal/collar paid, terminal trace, or selector/collar drift.  The
remaining exact possible hidden failures are selector graph loss, signed
saturation loss, terminal trace atom, or legal routing defect.  Each of those
must be charged before the no-residue theorem can use the rigidity core.
