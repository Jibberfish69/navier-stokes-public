...
V_m\).  With those channel admissions in the same \(A_{4B}\) packet, the exact
four-body counting bridge is
...
harmonic pressure-memory collar tail, and bounded-overlap same-carrier
selection.
