...
channel, and the transported collar channel.  The local pressure term is not a
...
contains \(|Q_m^HV_m\cdot\nabla\chi_m|\,dy\,ds\).  With those channel
admissions in the same \(A_{4B}\) packet, the exact four-body counting bridge is
