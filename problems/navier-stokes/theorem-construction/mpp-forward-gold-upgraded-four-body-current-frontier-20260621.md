...
The remaining exact possible failures are harmonic pressure memory/collar
trace, selector graph loss, signed saturation loss, terminal trace atom, or
legal routing defect.  Each of those must be charged before the no-residue
theorem can use the rigidity core.
