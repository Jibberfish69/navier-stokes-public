...
later_followup: >-
  ...
  The full finite multiradius resonant-graph branch is later closed by
...
The later finite duplicate-growth closure closes this finite graph branch:
any dangerous duplicate output creates a larger dangerous sideband, so a finite
output-maximal dangerous pair cannot be canceled by any vector-moment graph.
The vector-moment certificate remains the correct local coefficient law, but
finite sideband closure is impossible for a directionally spread cross-shell
cloud.
...
Later closure: that finite vector-moment resonant graph is excluded by the
duplicate-growth obstruction; the live door moves to nonattainment,
