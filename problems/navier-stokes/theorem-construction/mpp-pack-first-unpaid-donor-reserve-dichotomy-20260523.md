...
2. The first-created branch collapses to terminal zero-radius Zeno ancestry.
   The terminal Zeno Pack-before-Part correction gives Part-first when pointwise participation remains and true `not Pack_Q` only when that record is absent.
