...
ns_viewer:
  ...
  edge_effect: "Audits the unsafe clause that cross-profile Pack atoms may simply land as Part/Field faces."
  upstream_origin:
  ...
  downstream_consequence: "For public Clay finality, Part/Field landing is not enough. The cross-profile Pack source atom must vanish, be uniformly integrated away, or belong to a profile that then enters a rigid contradiction; pdfs_final remains false."
---
...
Logical skeleton: distinguish CM Part/Field classification from no-genuine-exit
public theorem closure.

Mechanism tested: use Part/Field Part/Field landing of a terminal positive
cross-profile source atom as a closure of the public finality branch.

## What Face Landing Pays

The CM witness notes are clear. Part and Field are the legal terminal
faces for the same-fluid CM test. A Part/Field failure supports:
...
The Part/Field Part/Field landing remains a diagnostic support output. It cannot
be counted as public-finality progress unless it is paired with an additional
theorem excluding that first Part/Field from original smooth data.
