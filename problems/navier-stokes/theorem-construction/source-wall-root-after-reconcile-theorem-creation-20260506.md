# source.wall.root.after.reconcile theorem creation

## Target

- target obligation: source-wall-root-after-reconcile
- target label: source-wall-root-after-reconcile
- route role: Create the exact theorem-grade bridge required by source-wall-root-after-reconcile.
- theorem family: generic-bridge-theorem

## Created Theorem

source.wall.root.after.reconcile. Under the installed hypotheses recorded in the theorem packet, source-wall-root-after-reconcile.
...
- next subprimitive: source.wall.root.after.reconcile.Subprimitive -- minimal noncircular bridge for source-wall-root-after-reconcile
