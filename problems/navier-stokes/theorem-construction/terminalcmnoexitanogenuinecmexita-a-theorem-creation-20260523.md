# TerminalcmnoexitANogenuinecmexitA.A theorem creation
...
- route role: Create the exact theorem-grade bridge required by TerminalCMNoExit.A / NoGenuineCMExit.A.
- theorem family: generic-bridge-theorem

## Created Theorem

TerminalcmnoexitANogenuinecmexitA.A. Under the installed hypotheses recorded in the theorem packet, terminalCMNoExit.A / NoGenuineCMExit.A.
...
- TerminalcmnoexitANogenuinecmexitA.A
...
- next subprimitive: TerminalcmnoexitANogenuinecmexitA.A.Subprimitive -- minimal noncircular bridge for TerminalCMNoExit.A / NoGenuineCMExit.A
