# TerminalSignedSaturation.A theorem creation

## Target

- target obligation: TerminalSignedSaturation.A
- target label: terminal signed positive-source saturation / no-free-sink gate
- route role: Create the exact theorem-grade bridge required by terminal signed positive-source saturation / no-free-sink gate.
- theorem family: generic-bridge-theorem

## Created Theorem

TerminalSignedSaturation.A. Under the installed hypotheses recorded in the theorem packet, terminal signed positive-source saturation / no-free-sink gate.
...
- next subprimitive: TerminalSignedSaturation.A.Subprimitive -- minimal noncircular bridge for terminal signed positive-source saturation / no-free-sink gate
