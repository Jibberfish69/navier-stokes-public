...
- UniformTemporalSourceIntegrability_p_BASAC.A (contrapositive_exit; score=76)
- UniformTemporalSourceIntegrability_p_BASAC.A (compactness_defect_rigidity; score=79)
- UniformTemporalSourceIntegrability_p_BASAC.A (monotone_budget; score=70)
