...
payload = {
  ...
  "support_classification_law" => {
    "governing_cm_program" => "Exit(Q):=not Member(Q) through Silver Pack_Q / Part_{N,Q} / Field_{N,r,Q} after Pack admission, plus pre-Pack original-participation audit where needed",
    "rule" => "Every indexed forward-positive, positive-supplier, continuation, transfer, receiver/readout, export, or already-classified positive surface has no CM proof authority unless an exact bridge lands the same witness in Silver Pack_Q, Part_{N,Q}, or Field_{N,r,Q}, or proves the pre-Pack original-participation audit needed before not Pack_Q can be spent.",
    "cannot_do" => [
      "set the live CM frontier",
      "close TerminalCMNoExit.A / NoGenuineCMExit.A",
      "replace the Silver witness tree or the pre-Pack original-participation audit",
