...
FACE_RULES = {
  ...
  "typed_subset_Pack_Part_Field_Zeno" => {
    ...
    "cm_face_breaks" => ["Pack_Q", "Part_{N,Q}", "Field_{N,r,Q}"],
    "retention_rule" => "This row does not choose one face globally. The local branch chooses Pack, Part, Field, or a Zeno atom that then lands in Field."
  },
  "supplier_readout_support" => {
    ...
    "cm_face_breaks" => [],
    "retention_rule" => "No Pack/Part/Field break is promoted unless a named theorem lands this support surface in a face."
  },
  ...
  "source_recovery_or_history_not_face" => {
    ...
    "cm_face_breaks" => [],
    "retention_rule" => "History can supply provenance, not a CM face, until a theorem promotes it."
  },
  ...
  "support_context_needs_no_face_promotion" => {
    ...
    "cm_face_breaks" => [],
    "retention_rule" => "No CM face is promoted without a named landing theorem."
  }
}.freeze
...
def summarize_entry(entry)
  ...
  entry.merge(
    "failure_face_diagnostic" => {
      ...
      "cm_face_breaks" => rule.fetch("cm_face_breaks"),
...
output = {
  ...
  "claim_boundary" => {
    ...
    "cm_faces_only" => "The only CM witness faces are Pack_Q, Part_{N,Q}, and Field_{N,r,Q}; source-wall and readout notes are support unless the selected retained branch lands in one of those faces.",
  ...
  "cm_face_break_counts" => face_counts.sort.to_h,
