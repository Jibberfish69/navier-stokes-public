...
FORBIDDEN = {
  ...
  "old bare terminal limit Pack-only landing" => /terminal limit r_m -> 0 is not Pack_Q/,
  "old Zeno endpoint Pack-only landing" => /Zeno endpoint is `?not Pack_Q`?/,
  "old singular radius Pack-only implication" => /singular object has no positive radius, therefore not Pack_Q/,
  ...
  "old spaced r-star point not-Pack rule" => /r_\*\s*=\s*0\s*=>\s*not Pack_Q/,
  "old zero-scale terminal residues Pack landing" => /zero-scale terminal residues land in Pack/,
  ...
  "old the original NS participation law marker" => /the original NS participation law/,
  "old the original NS participation law shorthand" => /the original NS participation law/,
  "old original participation law shorthand" => /\bpointwise Part\b/,
  "old original-participation audit wording" => /original-participation audit/,
  "old original-participation wording" => /original-participation/,
  "old original-participation audit wording" => /original-participation audit/,
  "old pre-Pack original-participation audit wording" => /pre-Pack original-participation audit/,
  "old Part-first branch wording" => /\b(?:is|was|remains|becomes)\s+Part-first\b/,
  "old Part-side when wording" => /Part-side when/,
