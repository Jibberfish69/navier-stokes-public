...
Here is the case we actually have to deal with.
A vortex remains aligned with a positive extensional direction of the strain, so the strain amplifies its vorticity while incompressibility contracts the cross-section of the material filament.
...
Set them aside.
The hard case asks what happens if the vortex keeps repeating this exact motion.
