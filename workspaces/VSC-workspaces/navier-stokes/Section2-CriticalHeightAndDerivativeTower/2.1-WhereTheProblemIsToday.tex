...
The case we are dealing with is a vortex that keeps stretching at the exact balance between strain and viscosity.
Its vorticity stays aligned with a positive extensional direction of the strain, so the strain amplifies it while incompressibility contracts the cross-section of the material filament.
...
The question is immediate: does a smaller vortex give viscosity an advantage?
The Navier--Stokes scaling says that the balance survives.
