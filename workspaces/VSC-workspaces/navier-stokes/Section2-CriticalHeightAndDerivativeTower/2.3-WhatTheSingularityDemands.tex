...
The equation now builds the Tower for us.
At the first row,
\[
  V_1
  =\nu\Delta V_0
...
\begin{equation}\label{eq:BodyTemporalVelocityRecurrence}
  ...
  \nabla\cdot V_n=0.
\end{equation}
The temporal Tower is not an extra construction placed on top of Navier--Stokes.
It is what Navier--Stokes becomes when the singularity question makes us follow every later response.
...
The calculation also refuses to remain temporal.
...
The attempted singularity has produced a two-directional object.
