...
Section~3 builds the exact rectangle with the adjacent rows and pressure relations needed by the equation, controls it through the finite endpoint, and takes the resulting intersection.
