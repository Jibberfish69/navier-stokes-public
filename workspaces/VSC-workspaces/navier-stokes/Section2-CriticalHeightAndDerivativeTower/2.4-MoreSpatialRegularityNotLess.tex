...
It tells us which spatial height to test against the \(n\)-th temporal response.
...
For fixed \(N\) and \(M\), the rows through \(N\) and columns through \(M\) form one finite rectangle, and every finite coordinate belongs to one.
