...
A finite maximal time leaves a scale-critical concentration to examine: the field can remain smooth at every earlier time while activity concentrates at smaller scales before the endpoint.
