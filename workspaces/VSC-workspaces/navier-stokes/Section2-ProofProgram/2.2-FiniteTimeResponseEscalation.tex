...
Already at first order, \eqref{eq:MaterialAccelerationEquationBody} adds the transport derivative, and every further material derivative produces nonlinear products of temporal and spatial derivatives.
Those products and the pressure response become explicit when the Eulerian equation is differentiated in both time and space.
