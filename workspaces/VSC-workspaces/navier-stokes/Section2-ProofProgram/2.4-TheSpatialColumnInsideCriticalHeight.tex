...
At the endpoint the proof will use the relation in the other direction: the whole-terminal Sobolev rows first control the \(1/2\) and \(3/2\) levels, and those levels then control \(H\) and its first dissipative height.
