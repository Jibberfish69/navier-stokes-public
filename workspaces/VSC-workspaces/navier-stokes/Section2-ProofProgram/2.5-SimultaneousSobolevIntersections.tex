...
It is recovered at every finite depth from the original recurrence
\[
  Q_n=\partial_t^np,
\]
the differentiated momentum equation, incompressibility, and the pressure Poisson equation at every finite depth.
The differentiated momentum equation, incompressibility, and the pressure Poisson equation then recover the pressure jet from \(u\) without treating pressure as an element of the velocity space.

Each estimate will control one finite block of this intersection.
