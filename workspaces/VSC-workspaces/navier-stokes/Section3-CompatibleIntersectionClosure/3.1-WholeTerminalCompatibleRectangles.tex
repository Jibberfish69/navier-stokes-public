...
\begin{proposition}[Terminal realization of the rectangle estimate]\label{thm:WholeTerminalCompatibleRectangleEstimate}
...
\begin{proof}
Fix \(N,M\).
For every \(0\leq n\leq N\), Theorem~\ref{thm:BodyWholeTerminalRectangleTheorem} and monotone convergence give
\[
  V_n\in L^2(I_*;H^{M+1}),
  \qquad
