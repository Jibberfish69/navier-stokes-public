...
The rectangle \(\cR_{0,2}[u_0]\) gives this critical trace.
The higher rectangles place the same \(u\) in every spatial Sobolev row, which is the input needed to obtain one terminal value in every \(H^m\).
