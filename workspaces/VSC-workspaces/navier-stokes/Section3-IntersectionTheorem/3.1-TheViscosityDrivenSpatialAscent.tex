...
\end{proof}
Solving the triangular row for its highest energy gives
...
sum.  The completed row names the exact collection that has to be controlled
...
the transfer chain on its right.
