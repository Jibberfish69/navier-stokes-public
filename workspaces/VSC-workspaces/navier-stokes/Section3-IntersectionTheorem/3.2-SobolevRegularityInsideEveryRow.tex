...
the temporal response.  Moving across changes the spatial height.  On a fixed
strict interval \(I=(0,T)\), \(T<T_*\), classical smoothness makes every
finite entry in this grid finite by \Cref{prop:LocalMaximalHistory}.  The lines
above show how the entries are coupled; none is a control that survives as
\(T\uparrow T_*\).
