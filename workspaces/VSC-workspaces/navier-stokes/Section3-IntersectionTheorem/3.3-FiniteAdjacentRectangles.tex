...
\end{equation}
Terminal information asks for one stronger statement.  Once \(N\) and \(M\) have
been chosen, \(\mathfrak R_{N,M}(u;T)\) has to remain bounded over every
\(0<T<T_*\).  This is the estimate that carries a finite rectangle to \(T_*\).
