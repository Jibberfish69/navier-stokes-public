...
\captionof{table}{The rectangle (
\mathcal R_{1,2}).  The row (V_1) is shared: it is the time derivative used to trace (V_0), and it is also the next response whose own trace is paired with (V_2).}
