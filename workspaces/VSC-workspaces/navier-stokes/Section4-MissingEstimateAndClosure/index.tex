...
\[
  u,p\in C^\infty\!\bigl(\R^3\times[0,\infty)\bigr).
\]
This proves \eqref{eq:BodyGlobalSmoothnessConclusion} and the time requirement
\eqref{eq:GlobalTimeTarget}.
...
\[
  ...
  <\infty,
\]
where the last finiteness is the \(m=0\) case of
\eqref{eq:FeffermanDatumSobolevRows}.  Global smoothness of \(u,p\) and the
