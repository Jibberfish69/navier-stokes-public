...
time.  The same low rectangle supplies \(L^2_tH^3_x\) for this shell action and
\(C_tH^2_x\) for the uniform critical-tail estimate
\eqref{eq:BodyUniformUltravioletVanishing}.  This is still a finite-order consequence:
...
\(u\in L^2(I_*;H^2)\),
\[
  \nabla u\in L^2(I_*;H^1)
  \hookrightarrow L^2(I_*;L^3),
\]
