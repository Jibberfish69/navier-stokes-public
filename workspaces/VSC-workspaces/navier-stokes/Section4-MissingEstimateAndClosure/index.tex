...
What matters here is simpler: for each fixed \(r\), the singularity asks \(V_r\) to
...
construction, including trace compatibility and smooth gluing.  It reaches the same
conclusion without asking the reader to carry that technical assembly through the
physical argument in the body.
...
controls the shear responsible for vortex stretching.  These are not three unrelated
citations pasted onto the intersection; they are three established ways of reading the
