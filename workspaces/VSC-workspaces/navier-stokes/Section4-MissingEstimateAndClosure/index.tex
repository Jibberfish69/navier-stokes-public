...
\begin{proof}
Assume that \(T_*<\infty\). The \(L^3\) argument above already closes this branch; the complete intersection reaches the same contradiction through a common endpoint and restart.
