...
The velocity therefore needs both indices.
...
This is the velocity intersection.
The pressure-complete Navier--Stokes object also contains \(Q_n=\partial_t^np\), the differentiated momentum equation, the divergence constraint, and the pressure Poisson equation at every retained depth.
Those relations were derived in the mixed recurrence.
The next step is to find a finite piece of the velocity intersection that produces an actual time trace while carrying those pressure-complete relations with it.
