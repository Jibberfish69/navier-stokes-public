...
Because pressure is determined only up to an additive function of time, the same normalization is used on both intervals.
...
Regularity names the kind and degree of function-space control available for the solution.
Smoothness is the all-orders classical class \(C^\infty\), and continuation asks whether the Navier--Stokes solution can be extended past \(T\) while remaining in that class.
