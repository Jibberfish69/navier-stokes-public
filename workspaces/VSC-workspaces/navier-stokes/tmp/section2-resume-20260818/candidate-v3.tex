...
The dangerous case is the one in which that geometry persists and the rotation still gains while viscosity is acting on it.
Then the next stretch would begin from a smaller cross-section with the rotational gain still intact.
...
We can isolate that comparison by taking one fixed vortex profile and placing it at a smaller width.
